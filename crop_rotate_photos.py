...
PHOTO_SN = 0
#with open('PHOTO_SN.pkl', 'wb') as f:
#    pickle.dump(PHOTO_SN, f)
with open('PHOTO_SN.pkl', 'rb') as f:
    pickle.load(f)

print "PHOTO_SN: ",PHOTO_SN
...
if __name__ == '__main__':
    filepath = "/media/cg/LENOVO_USB_HDD/11/"
    outputpath = "/media/cg/LENOVO_USB_HDD//output_11/"
    MIN_AREA_RATIO = 0.01
    SCALE_RATIO = 0.05
    margin_ratio = 0.02
    TIMEOUT = 2
    ...
    for sn, filename in enumerate(listdir(filepath)):
